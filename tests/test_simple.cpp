 ...
 * @brief Simple tests for basic functionality
...
TEST_F(SimpleTest, NfsdAppHealth) {
    auto app = std::make_unique<SimpleNfsd::NfsdApp>();
...
TEST_F(SimpleTest, NfsServerStats) {
    auto nfs_server = std::make_unique<SimpleNfsd::NfsServerSimple>();
...
TEST_F(SimpleTest, NfsServerHealth) {
    auto nfs_server = std::make_unique<SimpleNfsd::NfsServerSimple>();
...
TEST_F(SimpleTest, RpcMessageCreation) {
...
TEST_F(SimpleTest, RpcMessageSerialization) {
    SimpleNfsd::RpcMessage message;
    message.header.xid = 0x12345678;
    message.header.type = SimpleNfsd::RpcMessageType::CALL;
    message.header.rpcvers = 2;
...
TEST_F(SimpleTest, RpcMessageDeserialization) {
...
TEST_F(SimpleTest, RpcMessageValidation) {
    SimpleNfsd::RpcMessage message;
    message.header.xid = 0x12345678;
    message.header.type = SimpleNfsd::RpcMessageType::CALL;
    message.header.rpcvers = 2;
...
TEST_F(SimpleTest, AuthManagerInvalidAuth) {
    auto auth_manager = std::make_unique<SimpleNfsd::AuthManager>();
    auth_manager->initialize();
...
TEST_F(SimpleTest, AuthManagerConfiguration) {
    auto auth_manager = std::make_unique<SimpleNfsd::AuthManager>();
    auth_manager->initialize();
...
// Test integration
TEST_F(SimpleTest, ComponentIntegration) {
...
// Test error handling
TEST_F(SimpleTest, ErrorHandling) {
